...
public class SlidingTabsColorsFragment extends Fragment {
    ...
    static class SamplePagerItem {
        ...
        SamplePagerItem(CharSequence title, int indicatorColor, int dividerColor, CharSequence info) {
            mTitle = title;
        ...
        Fragment createFragment() {
            return ContentFragment.newInstance(mTitle, mIndicatorColor, mDividerColor, mInfo);
        }
        ...
        CharSequence getInfo() { return mInfo; }
    }

    static final String LOG_TAG = "- Sliding Tab Colors -";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabs.add(new SamplePagerItem(
                ...
                getString(R.string.tab_stream_info)
        ));
