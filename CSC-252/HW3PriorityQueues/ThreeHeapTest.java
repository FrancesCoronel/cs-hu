/*
 * Testing program for Three Heap.
 */

import java.util.*;

public class ThreeHeapTest {
	
	public static void main(String[] args) 
	{
		ThreeHeap testThreeHeap = new ThreeHeap();
		...
		testConstructor(testThreeHeap);
		System.out.println("Constructor test passed!");
		
		// test 1
		System.out.println("Starting test 1...");
		test1(testThreeHeap, testData, sortedData);
   ...
   public static void testConstructor(ThreeHeap genericHeap)
   {
   ...
   public static void test1(ThreeHeap genericHeap, double[][] testData, double[][] sortedData)
   {
   ...
   public static void test2(ThreeHeap genericHeap, double[][] testData, double[][] sortedData)
   {
    	for (int i = 0; i < testData.length; i++)
    	{
    		System.out.println("		Starting test for testData" + (i + 1));
